...
class MenuWindow(ba.Window):
   def __init__(self, origin: Sequence[float] = (0, 0)):
     ...
     if ba.app.config["public_config"]["party_stats_version"] <= 0:
            Bsversion = "Error"
     elif ba.app.config["public_config"]["party_stats_version"] <= 13700:
            Bsversion = "1.3"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14000:
        	Bsversion = "1.4"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14233:
        	Bsversion = "1.4.95"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14241:
        	Bsversion = "1.4.96"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14244:
        	Bsversion = "1.4.97"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14248:
        	Bsversion = "1.4.98"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14252:
        	Bsversion = "1.4.99"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14264:
        	Bsversion = "1.4.100"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14268:
        	Bsversion = "1.4.101"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14280:
        	Bsversion = "1.4.106"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14286:
        	Bsversion = "1.4.111"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14298:
        	Bsversion = "1.4.118"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14302:
        	Bsversion = "1.4.121"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14306:
        	Bsversion = "1.4.125"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14307:
        	Bsversion = "1.4.126"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14313:
        	Bsversion = "1.4.130"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14315:
        	Bsversion = "1.4.131"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14316:
        	Bsversion = "1.4.132"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14318:
        	Bsversion = "1.4.133"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14322:
        	Bsversion = "1.4.134"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14324:
        	Bsversion = "1.4.135"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14327:
        	Bsversion = "1.4.136"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14331:
        	Bsversion = "1.4.137"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14336:
        	Bsversion = "1.4.138"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14340:
        	Bsversion = "1.4.139"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14343:
        	Bsversion = "1.4.140"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14344:
        	Bsversion = "1.4.141"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14346:
        	Bsversion = "1.4.142"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14347:
        	Bsversion = "1.4.143"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14350:
        	Bsversion = "1.4.144"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14351:
        	Bsversion = "1.4.145"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14354:
        	Bsversion = "1.4.146"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14364:
        	Bsversion = "1.4.147"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14365:
        	Bsversion = "1.4.148"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14367:
        	Bsversion = "1.4.149"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14369:
        	Bsversion = "1.4.150"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14371:
        	Bsversion = "1.4.151"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14372:
        	Bsversion = "1.4.152"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14374:
        	Bsversion = "1.4.153"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14375:
        	Bsversion = "1.4.154"
     elif ba.app.config["public_config"]["party_stats_version"] <= 14377:
        	Bsversion = "1.4.155" 
     elif ba.app.config["public_config"]["party_stats_version"] <= 20001:
        	Bsversion = "1.5.0"  
     elif ba.app.config["public_config"]["party_stats_version"] <= 20062:
        	Bsversion = "1.5.1"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20063:
        	Bsversion = "1.5.2"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20065:
        	Bsversion = "1.5.3"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20067:
        	Bsversion = "1.5.4"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20069:
        	Bsversion = "1.5.5"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20072:
        	Bsversion = "1.5.6"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20077:
        	Bsversion = "1.5.7"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20079:
        	Bsversion = "1.5.8"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20081:
        	Bsversion = "1.5.9"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20083:
        	Bsversion = "1.5.10"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20084:
        	Bsversion = "1.5.11"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20087:
        	Bsversion = "1.5.12"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20095:
        	Bsversion = "1.5.13"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20096:
        	Bsversion = "1.5.14"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20097:
        	Bsversion = "1.5.15"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20099:
        	Bsversion = "1.5.16"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20102:
        	Bsversion = "1.5.17"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20106:
        	Bsversion = "1.5.18"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20114:
        	Bsversion = "1.5.19"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20126:
        	Bsversion = "1.5.20"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20136:
        	Bsversion = "1.5.21"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20145:
        	Bsversion = "1.5.23"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20159:
        	Bsversion = "1.5.24"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20164:
        	Bsversion = "1.5.25"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20178:
        	Bsversion = "1.5.26"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20218:
        	Bsversion = "1.5.27"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20238:
        	Bsversion = "1.5.27"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20239:
        	Bsversion = "1.5.28"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20247:
        	Bsversion = "1.5.29"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20263:
        	Bsversion = "1.5.30"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20268:
        	Bsversion = "1.6.0"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20362:
        	Bsversion = "1.6.1"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20365:
        	Bsversion = "1.6.2"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20366:
        	Bsversion = "1.6.3"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20367:
        	Bsversion = "1.6.4"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20388:
        	Bsversion = "1.6.5"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20394:
        	Bsversion = "1.6.6"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20394:
        	Bsversion = "1.6.7"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20444:
        	Bsversion = "1.6.8"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20461:
        	Bsversion = "1.6.9"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20501:
        	Bsversion = "1.6.10"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20514:
        	Bsversion = "1.6.11"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20542:
        	Bsversion = "1.6.12"
     elif ba.app.config["public_config"]["party_stats_version"] <= 20599:
        	Bsversion = "1.6.12+"
     elif ba.app.config["public_config"]["party_stats_version"] <= 30001:
        	Bsversion = "UNKNOWN"
...
class NewUIRow:
    ...
    def update(self, index: int, party: PartyEntry, sub_scroll_width: float,
        ...
        ping_good = _ba.get_account_misc_read_val('pingGood', 10)
        ping_med = _ba.get_account_misc_read_val('pingMed', 80)
       ...
       # thx for This Github.com
        ...
        if party.version <= 13700:
            Bsversion = "1.3"
        elif party.version <= 14000:
        	Bsversion = "1.4"
        elif party.version <= 14233:
        	Bsversion = "1.4.95"
        elif party.version <= 14241:
        	Bsversion = "1.4.96"
        elif party.version <= 14244:
        	Bsversion = "1.4.97"
        elif party.version <= 14248:
        	Bsversion = "1.4.98"
        elif party.version <= 14252:
        	Bsversion = "1.4.99"
        elif party.version <= 14264:
        	Bsversion = "1.4.100"
        elif party.version <= 14268:
        	Bsversion = "1.4.101"
        elif party.version <= 14280:
        	Bsversion = "1.4.106"
        elif party.version <= 14286:
        	Bsversion = "1.4.111"
        elif party.version <= 14298:
        	Bsversion = "1.4.118"
        elif party.version <= 14302:
        	Bsversion = "1.4.121"
        elif party.version <= 14306:
        	Bsversion = "1.4.125"
        elif party.version <= 14307:
        	Bsversion = "1.4.126"
        elif party.version <= 14313:
        	Bsversion = "1.4.130"
        elif party.version <= 14315:
        	Bsversion = "1.4.131"
        elif party.version <= 14316:
        	Bsversion = "1.4.132"
        elif party.version <= 14318:
        	Bsversion = "1.4.133"
        elif party.version <= 14322:
        	Bsversion = "1.4.134"
        elif party.version <= 14324:
        	Bsversion = "1.4.135"
        elif party.version <= 14327:
        	Bsversion = "1.4.136"
        elif party.version <= 14331:
        	Bsversion = "1.4.137"
        elif party.version <= 14336:
        	Bsversion = "1.4.138"
        elif party.version <= 14340:
        	Bsversion = "1.4.139"
        elif party.version <= 14343:
        	Bsversion = "1.4.140"
        elif party.version <= 14344:
        	Bsversion = "1.4.141"
        elif party.version <= 14346:
        	Bsversion = "1.4.142"
        elif party.version <= 14347:
        	Bsversion = "1.4.143"
        elif party.version <= 14350:
        	Bsversion = "1.4.144"
        elif party.version <= 14351:
        	Bsversion = "1.4.145"
        elif party.version <= 14354:
        	Bsversion = "1.4.146"
        elif party.version <= 14364:
        	Bsversion = "1.4.147"
        elif party.version <= 14365:
        	Bsversion = "1.4.148"
        elif party.version <= 14367:
        	Bsversion = "1.4.149"
        elif party.version <= 14369:
        	Bsversion = "1.4.150"
        elif party.version <= 14371:
        	Bsversion = "1.4.151"
        elif party.version <= 14372:
        	Bsversion = "1.4.152"
        elif party.version <= 14374:
        	Bsversion = "1.4.153"
        elif party.version <= 14375:
        	Bsversion = "1.4.154"
        elif party.version <= 14377:
        	Bsversion = "1.4.155" 
        elif party.version <= 20001:
        	Bsversion = "1.5.0"  
        elif party.version <= 20062:
        	Bsversion = "1.5.1"
        elif party.version <= 20063:
        	Bsversion = "1.5.2"
        elif party.version <= 20065:
        	Bsversion = "1.5.3"
        elif party.version <= 20067:
        	Bsversion = "1.5.4"
        elif party.version <= 20069:
        	Bsversion = "1.5.5"
        elif party.version <= 20072:
        	Bsversion = "1.5.6"
        elif party.version <= 20077:
        	Bsversion = "1.5.7"
        elif party.version <= 20079:
        	Bsversion = "1.5.8"
        elif party.version <= 20081:
        	Bsversion = "1.5.9"
        elif party.version <= 20083:
        	Bsversion = "1.5.10"
        elif party.version <= 20084:
        	Bsversion = "1.5.11"
        elif party.version <= 20087:
        	Bsversion = "1.5.12"
        elif party.version <= 20095:
        	Bsversion = "1.5.13"
        elif party.version <= 20096:
        	Bsversion = "1.5.14"
        elif party.version <= 20097:
        	Bsversion = "1.5.15"
        elif party.version <= 20099:
        	Bsversion = "1.5.16"
        elif party.version <= 20102:
        	Bsversion = "1.5.17"
        elif party.version <= 20106:
        	Bsversion = "1.5.18"
        elif party.version <= 20114:
        	Bsversion = "1.5.19"
        elif party.version <= 20126:
        	Bsversion = "1.5.20"
        elif party.version <= 20136:
        	Bsversion = "1.5.21"
        elif party.version <= 20145:
        	Bsversion = "1.5.23"
        elif party.version <= 20159:
        	Bsversion = "1.5.24"
        elif party.version <= 20164:
        	Bsversion = "1.5.25"
        elif party.version <= 20178:
        	Bsversion = "1.5.26"
        elif party.version <= 20218:
        	Bsversion = "1.5.27"
        elif party.version <= 20238:
        	Bsversion = "1.5.27"
        elif party.version <= 20239:
        	Bsversion = "1.5.28"
        elif party.version <= 20247:
        	Bsversion = "1.5.29"
        elif party.version <= 20263:
        	Bsversion = "1.5.30"
        elif party.version <= 20268:
        	Bsversion = "1.6.0"
        elif party.version <= 20362:
        	Bsversion = "1.6.1"
        elif party.version <= 20365:
        	Bsversion = "1.6.2"
        elif party.version <= 20366:
        	Bsversion = "1.6.3"
        elif party.version <= 20367:
        	Bsversion = "1.6.4"
        elif party.version <= 20388:
        	Bsversion = "1.6.5"
        elif party.version <= 20394:
        	Bsversion = "1.6.6"
        elif party.version <= 20394:
        	Bsversion = "1.6.7"
        elif party.version <= 20444:
        	Bsversion = "1.6.8"
        elif party.version <= 20461:
        	Bsversion = "1.6.9"
        elif party.version <= 20501:
        	Bsversion = "1.6.10"
        elif party.version <= 20514:
        	Bsversion = "1.6.11"
        elif party.version <= 20542:
        	Bsversion = "1.6.12"
        elif party.version <= 20599:
        	Bsversion = "1.6.12+"
        elif party.version <= 20600:
        	Bsversion = "UNKNOWN"
...
class NewPublicGatherTab(GatherTab):
    ...
    def _public_party_activate(self, party: PartyEntry) -> None:
        """Called when a party is clicked or otherwise activated."""
        url = party.stats_addr.replace('${ACCOUNT}', _ba.get_account_misc_read_val_2('resolvedAccountID', 'UNKNOWN'))
        ba.app.config["public_config"]["party_stats_name"] = party.name
        ba.app.config["public_config"]["party_stats_address"] = party.address
        ba.app.config["public_config"]["party_stats_language"] = party.language
        ba.app.config["public_config"]["party_stats_port"] = party.port
...
class UwUuser(ba.Plugin):
    def __init__(self):
        if _ba.env().get("build_number",0) >= 20366 and _ba.env().get("build_number",0) <= 20394:
            GP.UIRow = NewUIRow
            GP.AddrFetchThread = NewAddrFetchThread
            GP.PingThread = NewPingThread
            GP.PublicGatherTab = NewPublicGatherTab
            
        else:print("Public.py only runs with BobmSquad version 1.6.4 for now.")
