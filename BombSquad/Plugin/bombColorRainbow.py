...
class New_Bomb(ba.Actor):
    ...
    def __init__(self,
        ...
        if self.bomb_type == 'land_mine':
            ...
            self.node = ba.newnode('prop',
                                   ...
                                   attrs={
                                       ...
                                       'body_scale': self.scale,
                                       'shadow_size': 0.5,
                                       'color_texture': ba.gettexture('logo'),
                                       'reflection': 'soft',
        ...
        if self.bomb_type not in ('land_mine', 'tnt'):
            ...
            ba.timer(fuse_time, ba.WeakCall(self.handlemessage, ExplodeMessage()))
            self.shield = ba.newnode('shield', owner=self.node, attrs={'color':(1,1,1),'radius':0.45})
            self.node.connectattr('position', self.shield, 'position')   
            ba.animate_array(self.shield, 'color', 3, {0:(random.choice([1,2,3,4,5,6,7,8,9]), random.choice([1,2,3,4,5,6,7,8,9]), random.choice([1,2,3,4,5,6,7,8,9])), 0.2: (2,0,2), 0.4: (2,2,0), 0.6: (0,2,0), 0.8: (0,2,2), 1: (0,0,2), 1.2: (2,0,0)}, loop = True)
            self.shield2 = ba.newnode('shield', owner=self.node, attrs={'color':(1,1,1),'radius':0.6})
            self.node.connectattr('position', self.shield2, 'position')   
            ba.animate_array(self.shield2, 'color', 3, {0:(random.choice([1,2,3,4,5,6,7,8,9]), random.choice([1,2,3,4,5,6,7,8,9]), random.choice([1,2,3,4,5,6,7,8,9])), 0.2: (2,0,2), 0.4: (2,2,0), 0.6: (0,2,0), 0.8: (0,2,2), 1: (0,0,2), 1.2: (2,0,0)}, loop = True)
        ...
        if node:
            if (self.bomb_type == 'impact' and
                (node is self.owner or
                 (isinstance(node_delegate, New_Bomb) and node_delegate.bomb_type
